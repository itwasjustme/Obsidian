...
7) I used the Null Byte Bypass payload:
...
8) What I understood of Null Byte Bypass; It is a technique used if the site is expecting some .png file, and the payload ../../../etc/passwd%00.png, the null byte reference **%00** nulls out the .png extension which leaves us the traversal sequence, bypassing the null byte. Giving us the content of /etc/passwd:
